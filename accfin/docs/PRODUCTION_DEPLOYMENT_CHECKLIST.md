...
**Target version:** `0.13.3-case-retry-hermes-timeout` (migrations `001`–`047`; finance-ui `0.13.1-case-retry`)
...
| # | Check | Expected |
|---|-------|----------|
| E4.1 | `GET /health` (internal or via `https://finance.mmlogistix.bp0.work/health`) | `200`, version `0.13.3-case-retry-hermes-timeout` |
