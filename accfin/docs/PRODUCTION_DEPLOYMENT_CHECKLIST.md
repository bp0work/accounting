...
**Target version:** `0.13.12-outbound-mail-greenlet-fix` (migrations `001`–`047`; finance-ui `0.13.5-login-totp-input-fix`)
...
| # | Check | Expected |
|---|-------|----------|
| E4.1 | `GET /health` (internal or via `https://finance.mmlogistix.bp0.work/health`) | `200`, version `0.13.12-outbound-mail-greenlet-fix` |
