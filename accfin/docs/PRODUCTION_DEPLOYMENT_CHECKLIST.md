...
**Target version:** `0.12.9-mail-pdf-sanitize` (migrations `001`–`047`; finance-ui `0.12.5-finance-token-refresh`)
...
| # | Check | Expected |
|---|-------|----------|
| E4.1 | `GET /health` (internal or via `https://finance.mmlogistix.bp0.work/health`) | `200`, version `0.12.9-mail-pdf-sanitize` |
