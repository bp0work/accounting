...
| # | Check | Expected |
|---|-------|----------|
| E4.1 | `GET /api/health` (internal or via `https://finance.mmlogistix.bp0.work/api/health`) | `200`, version `0.14.2-client-admin-fixes` |
...
| E5.11 | **Client Admin UI** `admin.mmlogistix.bp0.work`: dashboard detail checks; signatures; policy/regulatory PDF upload; `/travel-info`; generate 13 periods; migration `051` (`0.14.2`) | ☐ |
