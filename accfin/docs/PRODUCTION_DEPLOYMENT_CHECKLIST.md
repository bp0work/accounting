...
**Target version:** `0.13.2-case-visibility` (migrations `001`–`047`; finance-ui `0.13.0-case-dashboard`)
...
| # | Check | Expected |
|---|-------|----------|
| E4.1 | `GET /health` (internal or via `https://finance.mmlogistix.bp0.work/health`) | `200`, version `0.13.2-case-visibility` |
