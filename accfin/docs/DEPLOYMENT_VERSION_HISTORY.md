...
|----------------|------|------------|---------|
| **0.13.5-ollama-healthcheck-cli** | 2026-05-20 | *(pending)* | Ollama Docker healthcheck: `ollama list` via bundled CLI (image has neither `curl` nor `wget`). Supersedes `0.13.4` wget attempt. |
