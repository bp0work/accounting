...
|----------------|------|------------|---------|
| **0.13.1-mail-text-sanitize** | 2026-05-20 | *(pending)* | Sanitize all mail text fields at ingest (`body_text`, `body_html`, `body_preview`, `subject`, `extracted_text`) — strip NUL and invalid UTF-8 before PostgreSQL insert. |
