...
|----------------|------|------------|---------|
| **0.13.5-ollama-healthcheck-cli** | 2026-05-20 | `b354a7a` | Ollama Docker healthcheck: `ollama list` via bundled CLI (image has neither `curl` nor `wget`). Supersedes `0.13.4` wget attempt. Feature `e99848b`. |
