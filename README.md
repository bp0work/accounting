...
**Release version:** `0.14.73-journal-line-edit` (see `accfin/app/core/config.py` → `Settings.version` and `/api/health`). Finance UI: `0.14.73-journal-line-edit`. Client Admin: `0.14.69-login-portal-links`.
