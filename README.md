...
**Release version:** `0.14.63-line-items-set-committed` (see `accfin/app/core/config.py` → `Settings.version` and `/api/health`). Finance UI: `0.14.60-exp-submitter-escalation-ui`.
