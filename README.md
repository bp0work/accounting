...
**Release version:** `0.14.60-exp-submitter-escalation-ui` (Finance UI); API/workers `0.14.59-claimant-id-nullable` (see `accfin/app/core/config.py` → `Settings.version` and `/api/health`).
