...
**Release version:** `0.14.90-parsing-incomplete-retry-reset` (see `accfin/app/core/config.py` → `Settings.version` and `/api/health`). Finance UI: `0.14.87-retry-escalation-routing`. Client Admin: `0.14.69-login-portal-links`.
