...
**Release version:** `0.14.76-number-formatting` (see `accfin/app/core/config.py` → `Settings.version` and `/api/health`). Finance UI: `0.14.76-number-formatting`. Client Admin: `0.14.69-login-portal-links`.
