...
**Release version:** `0.14.68-approval-tier-role-mapping` (see `accfin/app/core/config.py` → `Settings.version` and `/api/health`). Finance UI: `0.14.68-approval-tier-role-mapping`. Client Admin: `0.14.66-coa-account-edit-save`.
