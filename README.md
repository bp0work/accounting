...
**Release version:** `0.14.77-submission-detail-page` (see `accfin/app/core/config.py` → `Settings.version` and `/api/health`). Finance UI: `0.14.77-submission-detail-page`. Client Admin: `0.14.69-login-portal-links`.
